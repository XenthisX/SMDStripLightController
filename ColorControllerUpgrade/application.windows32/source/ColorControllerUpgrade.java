...
public class ColorControllerUpgrade extends PApplet {
...
public void draw() {
  ...
  hueNum = Math.round((hueNumClean / 1.1f));
  ...
  if (controlP5.getController("Spectrum").value() == 0) {
    ...
    if (controlP5.getController("Cycle Color").value() == 1) {
      ...
      cycleNum = 0;
      controlP5.getController("Speed").hide();
      controlP5.getController("Speed").setValue(0.00f);
    }
    if (breatheNum == 1) {
...
public float constrainer(float input) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ColorControllerUpgrade" };
    if (passedArgs != null) {
